    ...
    <div class="row">
        <div class="login-frm">
            <div class="panel panel-default">
				...
				<div class="tab-content res-tab-con">
				  <div id="patient" class="tab-pane fade in active">
						<h3>Patient Register Form</h3>
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
						...
						<input id="role" type="hidden" class="form-control" name="role" value="patient" >
				  ...
				  <div id="doctor" class="tab-pane fade">
					...
					<form class="form-horizontal" method="POST" action="{{ route('register') }}">
						...
						<input id="role" type="hidden" class="form-control" name="role" value="doctor" >
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            <label for="email" class="col-md-4 control-label">E-Mail Address</label>
